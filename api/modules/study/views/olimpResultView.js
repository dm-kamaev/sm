 ...
 */
olympiadResultsView.transformResults = function(results) {
    var res = {},
        keys,
        schoolClass,
        year,
 ...
 * @private
 */
olympiadResultsView.sorter_ = function(a, b) {
    return (b.winners || 0) - (a.winners || 0) ||
        (b.awardees || 0) - (a.awardees || 0);
};

module.exports = olympiadResultsView;
