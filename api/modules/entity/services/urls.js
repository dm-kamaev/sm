 ...
 * @param {Object} school
 */
service.generateSchoolAlias = function(school) {
    service.generateEntityAlias(school, entityType.SCHOOL);
};

/**
 * @param {Object} course
 */
service.generateCourseAlias = function(course) {
    service.generateEntityAlias(course, entityType.COURSE);
};
