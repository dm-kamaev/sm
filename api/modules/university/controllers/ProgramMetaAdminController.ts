...
class ProgramMetaAdminController extends Controller {
    ...
    public async actionGet(actionContext: any, id: string) {
        ...
        const programMeta: ProgramPageMetaInformationInstance | {}
            = await programMetaService.get(programId) || {};

        const page: PageIntstance | null
            = await pageService.getOne(programId, entityTypes.PROGRAM);
    ...
    /**
    * @api {put} /api/admin/program/:id/pagemeta
    * Update program meta
    * @apiVersion 1.0.0
