...
class SearchQuery {
    ...
    constructor() {
         ...
         * @type {Object}
         */
        this.searchParams_ = squel.expr();

        /**
         * @private
         * @type {number}
         */
        this.searchDataCount_ = 0;
     ...
     */
    setSearchData_() {
        if (this.searchDataCount_) {
            this.innerQuery_
                .from('school_search_data')
                .from('school')
                .where(this.searchParams_)
