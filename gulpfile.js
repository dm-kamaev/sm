...
const tasks = function(bool) {
    return bool ?
        ['createTimestamp', 'soy', 'compile', 'svgSprite', 'tsCompile',
        'sprite', 'images', 'fonts', 'styles', 'copySchools',
        'copyCourses', 'localConfig'] :
        ['watch', 'soy', 'scripts', 'svgSprite', 'tsCompile', 'sprite',
