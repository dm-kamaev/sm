...
goog.provide('sm.lDoc.Template');

goog.require('soy');
goog.require('soydata');
goog.require('sm.lBase.Template');
goog.require('sm.lDoc.nDemo.bBlockBadge.Template');
goog.require('sm.lDoc.nDemo.bBlockComments.Template');
goog.require('sm.lDoc.nDemo.bBlockDataBlock.Template');
goog.require('sm.lDoc.nDemo.bBlockDiagram.Template');
goog.require('sm.lDoc.nDemo.bBlockFeedbackModal.Template');
goog.require('sm.lDoc.nDemo.bBlockFilters.Template');
goog.require('sm.lDoc.nDemo.bBlockMark.Template');
goog.require('sm.lDoc.nDemo.bBlockRating.Template');
goog.require('sm.lDoc.nDemo.bBlockSchoolList.Template');
goog.require('sm.lDoc.nDemo.bBlockSchoolListItem.Template');
goog.require('sm.lDoc.nDemo.bBlockScore.Template');
goog.require('sm.lDoc.nDemo.bBlockSort.Template');
goog.require('sm.lDoc.nDemo.bBlockStars.Template');
