goog.provide('sm.gDropdown.ViewSelectLegacy');
...
goog.inherits(sm.gDropdown.ViewSelectLegacy, cl.gDropdown.View);


goog.scope(function() {
    var DropdownSelectView = sm.gDropdown.ViewSelectLegacy;
